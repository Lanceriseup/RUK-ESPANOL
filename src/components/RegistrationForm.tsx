...
export default function RegistrationForm() {
  ...
  return (
    <section id="register" className="bg-[#f7f5f0] py-10 md:py-20 px-6">
      {/* Subtle divider from FAQ */}
      <div className="max-w-3xl mx-auto border-t border-[#c9a84c]/30 mb-6 md:mb-16" />
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-6 md:mb-10">
          ...
          <div className="w-16 h-px bg-[#c9a84c]/50 mx-auto mt-2 mb-2 md:mt-4 md:mb-4" />
          <p className="font-[family-name:var(--font-oswald)] text-[13px] md:text-xl uppercase tracking-[.12em] md:tracking-widest text-[#1a1a1a]">
        ...
        {submitted ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-[10px] md:space-y-4">
            ...
            <button
              type="submit"
              className="w-full bg-[#c9a84c] hover:bg-[#e4c06e] text-black font-[family-name:var(--font-oswald)] font-bold uppercase tracking-widest text-lg py-[13px] md:py-4 transition-colors duration-200 mt-2"
            >
              Submit
            </button>
          </form>
